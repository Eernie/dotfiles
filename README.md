# [Eernie](https://github.com/eernie)’s dotfiles
...
| OS | Snippet |
|:---|:---|
| `macOS` | `bash -c "$(curl -LsS https://raw.github.com/eernie/dotfiles/master/src/os/setup.sh)"` |
| `Ubuntu` | `bash -c "$(wget -qO - https://raw.github.com/eernie/dotfiles/master/src/os/setup.sh)"` |
